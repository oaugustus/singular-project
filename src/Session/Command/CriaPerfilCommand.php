...
class CriaPerfilCommand extends Command
{
    ...
    {
        $this->setName('session:cria-perfil')
            ->setDescription('Cria um novo registro de perfil na aplicação')
            ->setHelp('Para criar um novo perfil, informe o nome do perfil a ser criado. Ex.: singular session:cria-perfil Perfil')
            ->addArgument(
                'perfil',
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $perfil = $app['session.store.perfil']->save([
